...
function Ripple(obj)
	spawn(function()
		...
		Ripple.ZIndex = 8
		Ripple.Image = "rbxassetid://107567680655744"
...
function library.new(library, name, theme)
	...
	if theme == "dark" then
		...
		Background = Color3.fromRGB(204, 0, 51)
		zyColor = Color3.fromRGB(153, 0, 102)
		beijingColor = Color3.fromRGB(102, 0, 153)
	else
		MainColor = Color3.fromRGB(51, 0, 204)
		Background = Color3.fromRGB(0, 0, 225)
	...
	function window.Tab(window, name, icon)
		...
		TabIco.Image = ("rbxassetid://%s"):format((icon or 107567680655744))
